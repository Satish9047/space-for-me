...
const Footer = () => {
  return (
    <div className="py-6 mt-4 border-t border-black">
      <Container className="flex justify-between items-center">
        ...
        <nav className="flex gap-4">
          ...
          <Link to="/terms-of-service">Partner With Us</Link>
        </nav>
        <div className="flex gap-2">
          <Link
            to="/share"
            className="bg-white hover:bg-neutral-200 p-4 rounded-full"
          >
            <svg
              width="20px"
              height="20px"
          ...
          <Link
            to="https://satishprajapati.com.np"
            className="bg-white hover:bg-neutral-200 p-4 rounded-full"
          >
            <svg
              fill="#000000"
